...
基于 **Tauri 2 + Rust + Vue 3** 的跨平台桌面缓存管理工具，同时支持 **Redis** 与 **Memcached**。
...
| 连接列表 | 新建连接 |
| --- | --- |
| ![连接列表](docs/images/cn/connection-list.png) | ![新建连接](docs/images/cn/connection-add.png) |

| Redis 数据浏览 | Memcached 数据浏览 |
| --- | --- |
| ![Redis 数据浏览](docs/images/cn/redis-data.png) | ![Memcached 数据浏览](docs/images/cn/memcache-data.png) |

| Redis 服务器信息 | Memcached 服务器信息 |
| --- | --- |
